...
public class BookmarkModelHelper {
    ...
    public static ArrayList<BookmarkModel> getAllBookmarks(DBHelper helper, SQLiteDatabase db, boolean isOrderByDate) {
    ...
    public static ArrayList<BookmarkModel> getBookmarks(DBHelper helper, SQLiteDatabase db, PageModel page) {
        ArrayList<BookmarkModel> bookmarks = new ArrayList<BookmarkModel>();
    ...
    private static BookmarkModel getBookmark(DBHelper helper, SQLiteDatabase db, String page, int pIndex) {
    ...
    public static int insertBookmark(DBHelper helper, SQLiteDatabase db, BookmarkModel bookmark) {
        BookmarkModel tempBookmark = getBookmark(helper, db, bookmark.getPage(), bookmark.getpIndex());
    ...
    public static int deleteBookmark(DBHelper helper, SQLiteDatabase db, BookmarkModel bookmark) {
