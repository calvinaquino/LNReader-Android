...
public class FindMissingModelHelper {
	...
	public static ArrayList<FindMissingModel> getAllRedlinkChapter(SQLiteDatabase db) {
	...
	public static ArrayList<FindMissingModel> getAllMissingChapter( SQLiteDatabase db) {
		ArrayList<FindMissingModel> list = new ArrayList<FindMissingModel>();
	...
	public static ArrayList<FindMissingModel> getAllEmptyBook(SQLiteDatabase db) {
		ArrayList<FindMissingModel> list = new ArrayList<FindMissingModel>();
	...
	public static ArrayList<FindMissingModel> getAllEmptyNovel(SQLiteDatabase db) {
		ArrayList<FindMissingModel> list = new ArrayList<FindMissingModel>();
